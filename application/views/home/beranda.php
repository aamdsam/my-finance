...
<div class="title">Grafik Surplus/Defisit Tahun <?php echo date('Y');?></div>
...
echo '</table>';
echo '<div class="title">Surplus/Defisit</div>';
?>
<table class='grid'>
<tr>
    <th>Uraian</th>
...
foreach($surdef_bulan->result() as $row)
{
    ...
    $ket = '<font color="green">surplus</font>';
    if($saldo < 0) $ket = '<font color="red">defisit</red>';
    ?>
    <tr>
        <td>Surplus Defisit Bulan ini</td>
...
foreach($surdef_tahun->result() as $row)
{
    ...
    ?>
    <tr>
        <td>Surplus Defisit Tahun ini</td>
        <td align='right'><?php echo $this->fungsi->pecah($pemasukan);?></td>
        <td align='right'><?php echo $this->fungsi->pecah($pengeluaran);?></td>
        <td align='right'><?php echo $this->fungsi->pecah($saldo,'.',true);?></td>
        <td align='right'><?php echo $ket;?></td>
